...
from env_test4_env2 import GazeboEnv
...
file_names = ["TD3_velodyne_0", "TD3_velodyne_0", "TD3_velodyne_0", "TD3_velodyne_0"]
file_names2 = ["TD3_velodyne_1", "TD3_velodyne_1", "TD3_velodyne_1", "TD3_velodyne_1"]
...
environment_dim = 20
robot_dim = 6
env = GazeboEnv("env2_4robots.launch", environment_dim)
time.sleep(5)
