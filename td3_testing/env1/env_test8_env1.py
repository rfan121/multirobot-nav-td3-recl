...
class GazeboEnv:
    ...
    def _reset_single_robot(self, object_state, laserscan_data, robot_id):
        ...
        if robot_id == 0:
            ...
            object_state.pose.orientation.z = quaternion.z
            object_state.pose.orientation.w = quaternion.w
            self.set_state[4].publish(object_state)
            self.odom_x[4], self.odom_y[4] = x, y
            ...
            object_state.pose.orientation.z = quaternion.z
            object_state.pose.orientation.w = quaternion.w
            self.set_state[5].publish(object_state)
            self.odom_x[5], self.odom_y[5] = x, y
            ...
            object_state.pose.orientation.z = quaternion.z
            object_state.pose.orientation.w = quaternion.w
            self.set_state[6].publish(object_state)
            self.odom_x[6], self.odom_y[6] = x, y
            ...
            object_state.pose.orientation.z = quaternion.z
            object_state.pose.orientation.w = quaternion.w
            self.set_state[7].publish(object_state)
            self.odom_x[7], self.odom_y[7] = x, y
        ...
        if robot_id == 0:
            ...
            goal_x, goal_y = (self.goal_x[4], self.goal_y[4])
        elif robot_id == 5:
            goal_x, goal_y = (self.goal_x[5], self.goal_y[5])
        elif robot_id == 6:
            goal_x, goal_y = (self.goal_x[6], self.goal_y[6])
        elif robot_id == 7:
            goal_x, goal_y = (self.goal_x[7], self.goal_y[7])
