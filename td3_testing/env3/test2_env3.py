...
from env_test2_env3 import GazeboEnv
...
num_robots = 2  # Define the number of robots

file_names = ["TD3_velodyne_0", "TD3_velodyne_0"]
file_names2 = ["TD3_velodyne_1", "TD3_velodyne_1"]
...
environment_dim = 20
robot_dim = 6
env = GazeboEnv("env3_2robots.launch", environment_dim)
time.sleep(5)
